...
QDEF(MP_QSTR_carrier_duty_percent, (const byte*)"\x3e\x0c\x14" "carrier_duty_percent")
QDEF(MP_QSTR_carrier_freq, (const byte*)"\xc6\xd7\x0c" "carrier_freq")
...
QDEF(MP_QSTR_pulses, (const byte*)"\x29\x54\x06" "pulses")
...
QDEF(MP_QSTR_waiting, (const byte*)"\xee\x79\x07" "waiting")
